...
//             <p>If you haven't registered as a Supplier, sign up here.</p>
//             <button className="ghost" id="signIn" onClick={handlePanelSwitch}> Supplier</button>
//           </div>
//           <div className="overlay-panel-overlay-right">
//             <h1>First Time Here?</h1>
//             <p>If you haven't registered as a Wholesaler, sign up here.</p>
//             <button className="ghost" id="signUp" onClick={handlePanelSwitch}> Wholesaler</button>
//           </div>
//         </div>
//       </div>
//     </div>
  ...
  try {
    ...
    return (
      <div className={`register-request-container ${isRightPanelActive ? 'register-request-right-panel-active' : ''}`} id="register-request-container">
        {/* Supplier Registration */}
        {isRightPanelActive ? (
          <div className="register-request-form-container register-request-sign-up-container">
            <form onSubmit={handleSupplierSubmit}>
              <h1>Register as Supplier</h1>
              <span>Use your business details to register</span><br />
              <input
                ...
                name="username"
                value={supplierDetails.username}
              ...
              <input
                ...
                onChange={handleSupplierInputChange}
              /><br />
              <label /*style={{ color: '#ECCEAE', textAlign: 'left', display: 'block' }}*/>Business Proof</label><br />
              <input type="file" name="businessProof" onChange={handleSupplierInputChange} /><br />
              <label>Store Image</label><br/>
              <input type="file" name="storeImage" accept="image/*,video/*" onChange={handleSupplierInputChange} /><br />
              <input
                type="text"
                placeholder="Bank Account Information (Business Name)"
                name="bankAccountInfo"
                value={supplierDetails.bankAccountInfo}
                onChange={handleSupplierInputChange}
              /><br />
              <input
                type="email"
                ...
                onChange={handleSupplierInputChange}
              /><br />
              <div className="register-request-position-relative">
                <input
                  ...
                  onChange={handleSupplierInputChange}
                />
                <span className="register-request-password-icon" onClick={togglePasswordVisibility}>
                  <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} />
                </span>
              </div><br />
              <button type="submit">Register as Supplier</button>
              {error && <p className="register-request-error-message">{error}</p>}
            </form>
          </div>
        ) : (
          // Wholesaler Registration
          <div className="register-request-form-container register-request-sign-in-container">
            <form onSubmit={handleWholesalerSubmit}>
              <h1>Register as Wholesaler</h1>
              <span>Use your business details to register</span><br />
              <input
                ...
                placeholder="Username"
                name="username"
                value={wholesalerDetails.username}
              ...
              <input
                ...
                placeholder="Registered Business Name"
                name="businessName"
                value={wholesalerDetails.businessName}
                onChange={handleWholesalerInputChange}
              /><br />
              <input
                type="text"
                placeholder="Address of Business"
                name="address"
                value={wholesalerDetails.address}
                onChange={handleWholesalerInputChange}
              /><br />
              <label>Upload Business Proof (Business Registration Certificate, Tax ID, or Trade License)</label><br/>
              <input type="file" name="businessProof" onChange={handleWholesalerInputChange} /><br />
              <label>Upload Store Image/Video</label><br/>
              <input type="file" name="storeImage" accept="image/*,video/*" onChange={handleWholesalerInputChange} /><br />
              <input
                type="text"
                placeholder="Bank Account Information (Business Name)"
                name="bankAccountInfo"
                value={wholesalerDetails.bankAccountInfo}
                onChange={handleWholesalerInputChange}
              /><br />
              <input
                type="email"
              ...
              <div className="register-request-position-relative">
                <input
                  ...
                  placeholder="Password"
                  name="password"
                  value={wholesalerDetails.password}
                  onChange={handleWholesalerInputChange}
                />
                <span className="register-request-password-icon" onClick={togglePasswordVisibility}>
                  <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} />
        ...
        {/* Overlay */}
        <div className="register-request-overlay-container">
          <div className="register-request-overlay">
            <div className="register-request-overlay-panel register-request-overlay-left">
              <h1>Already Registered?</h1>
              <p>If you have already registered as a Supplier, sign in here.</p>
              <button className="register-request-overlay-button" onClick={handlePanelSwitch}>Register as Wholesaler</button>
            </div>
            <div className="register-request-overlay-panel register-request-overlay-right">
              <h1>First Time Here?</h1>
              <p>If you haven't registered as a Wholesaler, sign up here.</p>
              <button className="register-request-overlay-button" onClick={handlePanelSwitch}>Register as Supplier</button>
            </div>
          </div>
        </div>
      </div>
